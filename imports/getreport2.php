...
$sql = " SELECT programid, origfilename, rename_to, origsize, renamedsize, propname, description, catia_rel, jobfolder, id FROM enditem WHERE origfnnoext in ( SELECT origfnnoext FROM enditem GROUP BY origfnnoext HAVING COUNT(*) > 1 ) ";
